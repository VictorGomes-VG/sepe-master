...
<div class="row" style="border-radius: 30px; margin: 30px auto; background-color:rgba(300, 300, 300, 0.8); width: 850px">
    <h2 align="center" style="color: black;font-size: 56px; font-family: 'airbus'"> MATEMÁTICA !</h2>
</div>
<div class="container">
    <div class="row" style="border-radius: 30px; margin: auto; background-color:rgba(50, 50, 50, 0.9);width: 850px">
        <div class="col-md-12">
            <div class="col-md-4">
              ...
              <h3 align="center" style="color: white;font-size: 56px; font-family: 'airbus'"> FORMULARIO------------------------------------------------------------</h3>
